...
import com.example.administrator.myapplication.java.bean.weather;
...
public class Weather_Activity extends Activity {
    ...
    Handler h = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Gson gson = new Gson();
            weather wt=gson.fromJson(str,weather.class);

            weather pc = gson.fromJson(str, weather.class);
            if ("success".equals(wt.getErrMsg())) {
               // result1.setText(w.getRetData().toString());

              List<Map<String, Object>> res = new ArrayList<Map<String, Object>>();
                List<weather.RetDataBean> l = pc.getRetData();
